...
This document explains how to realize the behavior specified by the Corpus.

The Corpus specifies behavior.

The build plan sequences implementation.
...
Stop condition: repository installs locally and tests can run.
...
Implement provider-specific Catalysts only after the fake Catalyst passes contract tests.
